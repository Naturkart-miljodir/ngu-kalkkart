...
CHANNELS_EXCL = [
    ...
    "tectonic_",
    #"merged_250k_50k",
    "klassca_class_map_250k",
    #"klassca_",
    #"xgb_prediction_kesp_all_250k"
    "All_250K", 
    "klassca_class_map_merged_250k_50k",
    "60_250K",
    #"xgb_",
    "entropy_250K",
    "Kalkfattig_250K",
    "Kalkrik_250K",
    "Intermediaer_250K",
    "rgba_Merged_250K_50K",
    "klassca_entropy_merged_250k_50k",
    "klassca_prob_1_kalkfattig_merged_250k_50k",
    "klassca_prob_2_intermediaer_merged_250k_50k",
    "klassca_prob_3_kalkrik_merged_250k_50k",
    "xgb_prediction_KESP_All_Merged_250K_50K",
    "xgb_prediction_CaO_Top_60_Merged_250K_50K",
...
TILE_DIR = r"G:\UNET\DL_AE_chips"
OUT_ROOT = r"D:\Unet_models\MidNorge\Merged_250K_50K\With_Ca_average\Ca_conc_geophys"
...
need_channel_map = USE_CATEGORICAL_EMBEDDINGS or bool(excluded_predictor_names)
