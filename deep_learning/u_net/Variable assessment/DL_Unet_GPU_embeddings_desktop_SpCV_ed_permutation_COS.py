...
def build_channel_occlusion_plan(current_channel_rows, groups_to_run=None, mode="channel"):
...
def run_channel_occlusion_test_for_fold(
    ...
    for item in occlusion_plan:
        ...
        backup = X_work[..., idxs].copy()
        X_work[..., idxs] = fill_value

        occ_pred = predict_label_map(
            model,
            X_work,
            X_qua=Xva_qua,
            X_land=Xva_land,
