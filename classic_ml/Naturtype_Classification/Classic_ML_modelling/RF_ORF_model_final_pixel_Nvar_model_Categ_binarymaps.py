...
OUT_DIR = r"D:\Classical_ML_models\Lofoten\RF"
...
AREA_POLYGON_PATH = r"C:\Users\acosta_pedro\OneDrive - Norges geologiske undersøkelse\Geochemistry NGU_2026\Kalk_project\Study_area\Lofoten_kalk.shp"
...
INCLUDED_PREDICTORS_FILE = r"D:\Classical_ML_models\Test\Geo_predictors\With_Cord_pred\Categorical_maps\clean\predictors_used_for_modelling.csv"
...
FORCE_INCLUDED_PREDICTORS = ["coord_X", "coord_Y", "QuaternaryClass_id", "landuseCode_18_cog"]
...
def _fit_predict_orf_style_cpu(X_tr, y_tr, X_te, sample_weight=None, random_state=42):
    ...
    return pred, out_model, "sklearn_orf"
