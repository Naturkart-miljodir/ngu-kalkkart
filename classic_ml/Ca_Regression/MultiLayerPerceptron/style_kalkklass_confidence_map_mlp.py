...
BASE_DIR = Path(
    r"C:\Users\acosta_pedro\OneDrive - Norges geologiske undersøkelse\Geochemistry NGU_2026\Kalk_project\Modelling\MLP\KlassCa_modelling\Production"
)
INPUT_SUFFIX = "_calibrated_v3"
CLASS_MAP_PATH = BASE_DIR / f"KlassCa_class_map{INPUT_SUFFIX}.tif"
PROB_1_PATH = BASE_DIR / f"KlassCa_prob_1_Kalkfattig{INPUT_SUFFIX}.tif"
PROB_2_PATH = BASE_DIR / f"KlassCa_prob_2_Intermediaer{INPUT_SUFFIX}.tif"
PROB_3_PATH = BASE_DIR / f"KlassCa_prob_3_Kalkrik{INPUT_SUFFIX}.tif"

# Output visualization
OUT_RGBA_PATH = BASE_DIR / f"KlassCa_class_map_probstyled_rgba_mlp{INPUT_SUFFIX}.tif"
TMP_RGBA_PATH = BASE_DIR / f"KlassCa_class_map_probstyled_rgba_mlp{INPUT_SUFFIX}_tmp.tif"
