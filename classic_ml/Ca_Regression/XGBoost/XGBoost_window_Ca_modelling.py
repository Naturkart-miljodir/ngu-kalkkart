...
MATRIX_PATH = r"C:\Users\acosta_pedro\OneDrive - Norges geologiske undersøkelse\Geochemistry NGU_2026\Kalk_project\Modelling\Regression_matrix\Regression_matrix_XRFtotal_lab\Regression_matrix_XRFtotal_lab_withLOI\regression_matrix.npz"
OUT_DIR = r"C:\Users\acosta_pedro\OneDrive - Norges geologiske undersøkelse\Geochemistry NGU_2026\Kalk_project\Modelling\XGBoost\Ca_conc_modelling\Model_XRF_total_Lab\with_LOI\Geo_topo_bedrock_modelling_tuned\250K"

# List of predictors to exclude from the regression (by name)
EXCLUDED_PREDICTORS = ["Total_curvature_ch.tif","Hillshade_(MD)_ch.tif","Hillshade_(ZD)_ch.tif","Slope_ch.tif","Aspect(cos)_ch.tif","tri_ch.tif","VD1_ch.tif","slope.tif","Aspect(sin)_ch.tif","Bedrock_09.1_Kalkrik_50K_250K_merged.tif"]  # Example: exclude specific predictors by name


# === Target variables to run (each gets its own output subfolder and metrics) ===
TARGET_VARIABLES = ["KK","SS","KESP","CaO","CaMg_LOI_v"]  # Add or remove variables here
